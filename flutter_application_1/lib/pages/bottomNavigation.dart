...
import 'favorite_page.dart'; // Sesuaikan dengan nama file dan lokasi halaman FavoritePage Anda

class Bottom extends StatefulWidget {
  final int selectedIndex; // Tambahkan variabel selectedIndex
  Bottom({Key? key, required this.selectedIndex}) : super(key: key); // Tambahkan selectedIndex ke dalam constructor
    ...
    return SafeArea(
      child: SizedBox(
        ...
        child: BottomNavigationBar(
          ...
          currentIndex: widget.selectedIndex, // Gunakan selectedIndex dari widget
